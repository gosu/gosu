...
GOSU_FFI_API void Gosu_flush();
GOSU_FFI_API Gosu_Image* Gosu_render(int width, int height, void function(void *data), void* data, unsigned image_flags);
GOSU_FFI_API Gosu_Image* Gosu_record(int width, int height, void function(void *data), void* data);
GOSU_FFI_API void Gosu_clip_to(double x, double y, double width, double height, void function(void *data), void* data);

// Transformations
GOSU_FFI_API void Gosu_transform(double m0, double m1, double m2, double m3, double m4, double m5, double m6,
...
GOSU_FFI_API void Gosu_scale(double scale_x, double scale_y, double around_x, double around_y, void function(void *data), void* data);
GOSU_FFI_API void Gosu_rotate(double angle, double around_x, double around_y, void function(void *data), void* data);

GOSU_FFI_API void Gosu_clip_to(double x, double y, double width, double height, void function(void *data), void* data);

// Rendering
GOSU_FFI_API void Gosu_draw_line(double x1, double y1, unsigned c1,
                    double x2, double y2, unsigned c2,
                    double z, unsigned mode);
GOSU_FFI_API void Gosu_draw_triangle(double x1, double y1, unsigned c1,
                        double x2, double y2, unsigned c2,
                        double x3, double y3, unsigned c3,
                        double z, unsigned mode);
GOSU_FFI_API void Gosu_draw_rect(double x, double y, double width, double height, unsigned c, double z, unsigned mode);
GOSU_FFI_API void Gosu_draw_quad(double x1, double y1, unsigned c1,
                    double x2, double y2, unsigned c2,
                    double x3, double y3, unsigned c3,
...
GOSU_FFI_API long Gosu_milliseconds();
