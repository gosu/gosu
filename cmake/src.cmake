...
if(WIN32)
    ...
    OPTION(BUILD_DYNAMIC_LIBRARIES "Build dynamic libraries (not recommended)" OFF)
endif()
...
foreach(item ${LOOP_ITEMS})
    set(CORE_SRC_FILES ${CORE_SRC_FILES} ${CMAKE_CURRENT_SOURCE_DIR}/../src/${item})
endforeach()
