...
_wrap_screen_width(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_Gosu__Window, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Gosu::Window const *","Gosu::screen_width", 1, argv[0] )); 
    }
    arg1 = reinterpret_cast< Gosu::Window * >(argp1);
  }
  {
    try {
      result = (int)Gosu::screen_width((Gosu::Window const *)arg1);
    }
    catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
...
_wrap_screen_height(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_Gosu__Window, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Gosu::Window const *","Gosu::screen_height", 1, argv[0] )); 
    }
    arg1 = reinterpret_cast< Gosu::Window * >(argp1);
  }
  {
    try {
      result = (int)Gosu::screen_height((Gosu::Window const *)arg1);
    }
    catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
...
_wrap_available_width(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_Gosu__Window, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Gosu::Window const *","Gosu::available_width", 1, argv[0] )); 
    }
    arg1 = reinterpret_cast< Gosu::Window * >(argp1);
  }
  {
    try {
      result = (int)Gosu::available_width((Gosu::Window const *)arg1);
    }
    catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
...
_wrap_available_height(int argc, VALUE *argv, VALUE self) {
  ...
  if (argc > 0) {
    res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_Gosu__Window, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Gosu::Window const *","Gosu::available_height", 1, argv[0] )); 
    }
    arg1 = reinterpret_cast< Gosu::Window * >(argp1);
  }
  {
    try {
      result = (int)Gosu::available_height((Gosu::Window const *)arg1);
    }
    catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
