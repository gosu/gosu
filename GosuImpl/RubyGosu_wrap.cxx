...
void SwigDirector_Window::panic(std::exception const &e) {
  VALUE obj0 = Qnil ;
  VALUE result;
  
  obj0 = SWIG_NewPointerObj(SWIG_as_voidptr(&e), SWIGTYPE_p_std__exception,  0 );
  result = rb_funcall(swig_get_self(), rb_intern("panic"), 1,obj0);
}
...
SWIGINTERN VALUE
_wrap_Window_panic(int argc, VALUE *argv, VALUE self) {
  Gosu::Window *arg1 = (Gosu::Window *) 0 ;
  std::exception *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  int res2 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Gosu__Window, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Gosu::Window *","panic", 1, self )); 
  }
  arg1 = reinterpret_cast< Gosu::Window * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__exception,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::exception const &","panic", 2, argv[0] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::exception const &","panic", 2, argv[0])); 
  }
  ...
  try {
    {
      try {
        if (upcall) {
          (arg1)->Gosu::Window::panic((std::exception const &)*arg2);
        } else {
          (arg1)->panic((std::exception const &)*arg2);
        }
      } catch (const std::exception& e) {
        SWIG_exception(SWIG_RuntimeError, e.what());
      }
...
SWIGEXPORT void Init_gosu(void) {
  ...
  rb_define_method(SwigClassWindow.klass, "panic", VALUEFUNC(_wrap_Window_panic), -1);
