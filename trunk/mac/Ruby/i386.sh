...
export CFLAGS="-O3 -g -isysroot /Developer/SDKs/MacOSX10.4u.sdk -arch i386 -mmacosx-version-min=10.4"
../source/configure --enable-shared --build=i686-apple-darwin8.0
